        ...
        <div className="rounded-xl border border-white/10 bg-gray-900/50 p-3">
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder="Index"
              disabled={isRunning}
              className="w-full rounded-lg border border-white/10 bg-gray-800 px-3 py-2 text-sm text-white outline-none focus:border-sky-500 disabled:opacity-50"
            />
            <button
              type="button"
        ...
        <div className="rounded-xl border border-white/10 bg-gray-900/50 p-3">
          ...
          <div className="grid grid-cols-[1fr_1fr_auto] gap-2">
            <input
              ...
              placeholder="Index"
              disabled={isRunning}
              className="rounded-lg border border-white/10 bg-gray-800 px-3 py-2 text-sm text-white outline-none focus:border-emerald-500 disabled:opacity-50"
            />
            <input
              type="number"
              value={insertValue}
        ...
        <div className="rounded-xl border border-white/10 bg-gray-900/50 p-3">
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder="Index"
              disabled={isRunning}
              className="w-full rounded-lg border border-white/10 bg-gray-800 px-3 py-2 text-sm text-white outline-none focus:border-rose-500 disabled:opacity-50"
            />
            <button
              type="button"
